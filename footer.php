...
function draw_navbuttons() {
    ...
    if ($settings->nextbuttonshow && $next) {
        ...
        $output .= make_navbutton($icon, $bgcolour, get_string('nextactivity','block_navbuttons').': '.$next->name, $next->link, "next");
    }
    ...
    if ($settings->extra1show && $settings->extra1link) {
        ...
        $output .= make_navbutton($icon, $bgcolour, $settings->extra1title, $settings->extra1link, "extra1", $settings->extra1openin);
    }
    ...
    if ($settings->extra2show && $settings->extra2link) {
        ...
        $output .= make_navbutton($icon, $bgcolour, $settings->extra2title, $settings->extra2link, "extra2", $settings->extra2openin);
    }
