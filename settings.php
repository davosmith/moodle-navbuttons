...
if ($ADMIN->fulltree) {
    ...
    foreach ($plugins as $pluginname => $unused) {
        ...
        if (function_exists($funcname)) {
            $pluginopts[$pluginname][NAVBUTTONS_ACTIVITY_CUSTOM] = get_string(
                'activitycustom' . $pluginname,
                'block_navbuttons'
            );
        }
